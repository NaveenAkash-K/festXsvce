const eventsData: {
  ...
  },
  {
    ...
    events: [
      ...
      {
        name: "A Tech Pair",
        coordinators: { name: "Gowtham.S", contact: "9003066776" },
        date: "TBA",
        venue: "TBA",
        time: "TBA",
        team: "2",
        description: [
          "The event features two rounds: In the first, two participants work together for 5 minutes.",
          "One person, the catcher, guides the other, the responder, to guess a technical word using only one-word clues.",
          "Each guess counts as an attempt, with a maximum of three attempts allowed per word.",
          "In the second round, participants recreate a poster they've seen for 20 seconds within 30 to 45 minutes, testing memory and design skills rather than technical knowledge.",
          "In the 'Just a Minute' (JAM) final round, one participant writes on a given topic for 10 minutes.",
          "The content is then shown to their teammate for 2 minutes, who must analyze it.",
          "Afterwards, the teammate speaks on the topic for 3 minutes.",
        ],
        rules: [
          "The Participants will not be given any extra time.",
          "Indulging in any kind of malpractices will lead to disqualification of the team.",
          "The Participants will be judged based on their accuracy and time constraint.",
        ],
        requirements: ["TBA"],
      },
    ],

      ...
      <div className={styles.container}>
        <div className={styles.about}>
          ...
          <h3>
            ...
            conducted on the 15th and 16th of March 2024 this year. It offers a
            vibrant platform for students to exhibit their technical skills and
            creative flair. The festival unites students, faculty, and industry
            professionals from different engineering backgrounds thus promoting
            collaboration and showcasing the power of collective intelligence.
            Technoways embraces a holistic approach to technology, transcending
            academic boundaries, and encouraging exploration of
            interdisciplinary intersections. Participants engage in hands-on
            experiences, competitions, and workshops, gaining insights about
            emerging trends. The event catalyzes innovation, with prototypes
        ...
        <div className={styles.aboutSvce}>
          <div className={styles.wrapper}>
            ...
            <h3 className={styles.text}>
              ...
              on a 95-acre lush green Campus. It is housed in architecturally

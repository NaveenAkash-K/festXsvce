            ...
            <div className={styles.container}>
                <div className={styles.wrapper}>
                    ...
                    <div className={styles.contextContainer}>
                        ...
                        <h2>Description</h2>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ex aspernatur totam maxime, quos molestiae rem corporis fugit modi doloremque. Perspiciatis voluptatum ipsa ratione modi dignissimos aspernatur iure ab velit libero repellat! Ad molestias commodi quis tenetur quod nulla vero, nesciunt blanditiis illum voluptatum excepturi earum officia reprehenderit vel minima nihil!</p>
                        <h2>Rules</h2>
                        <ul>
                            <li>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Obcaecati, aliquid!</li>
                            <li>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Harum, iste.</li>
                            <li>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Omnis, odio.</li>
                        </ul>

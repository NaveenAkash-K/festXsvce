                ...
                <div className={styles.day1}>
                  ...
                  <div>
                    <input
                      ...
                      checked={mudwell}
                    />
                    <label htmlFor="MUDWELL">
                      MUDWELL MASTERY (1:00PM-2:30PM)
                    </label>
                  </div>
                  <div>
                    <input
                      ...
                      checked={techPair}
                    />
                    <label htmlFor="TECHPAIR">
                      TECH PAIR (10:30AM-12:30PM)
                    </label>
                  </div>
                  <div>
                    <input
                  ...
                  <div>
                    <input
                      ...
                      checked={thrill}
                    />
                    <label htmlFor="THRILL">
                      THRILL QUEST (10:00AM-3:00PM)
                    </label>
                  </div>
                  <div>
                    <input
                  ...
                  <div>
                    ...
                    />
                    <label htmlFor="CHEME">
                      CHEME CONNUNDRUM(12:00PM-3:00PM)
                    </label>
                  </div>
                  <div>
                    <input
                ...
                <div className={styles.day2}>
                  ...
                  <div>
                    <input
                      ...
                      checked={innosolve}
                    />
                    <label htmlFor="INNOSOLVE">
                      INNOSOLVE (9.30AM-12.30PM)
                    </label>
                  </div>
                  <div>
                    <input
                  ...
                  <div>
                    <input
                      ...
                      checked={relayRush}
                    />
                    <label htmlFor="RELAY RUSH">
                      RELAY RUSH (10.00AM-1.00PM)
                    </label>
                  </div>
                  <div>
                    <input
                  ...
                  <div>
                    <input
                      ...
                      checked={jokerCoder}
                    />
                    <label htmlFor="JOKER CODER">
                      JOKER CODER (9.30AM-2.30PM)
                    </label>
                  </div>
                  <div>
                    <input
                  ...
                  <div>
                    <input
                      ...
                      checked={thinkTank}
                    />
                    <label htmlFor="THINK TANK">
                      THINK TANK (10.00AM-1.00PM)
                    </label>
                  </div>
                </div>
              </div>
